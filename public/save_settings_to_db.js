        ...
        if (existingRecords.length === 0) {
            ...
            const insertResponse = await fetch(`${supabaseUrl}/rest/v1/deposit_methods`, {
                ...
                body: JSON.stringify({
                    ...
                    min_amount: (settings.minAmount || 100).toString(),
                    max_amount: (settings.maxAmount || 100000).toString(),
                    fee_percentage: (settings.feePercentage || 0).toString(),
                    fixed_fee: (settings.fixedFee || 25).toString(),
