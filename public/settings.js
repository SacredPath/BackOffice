...
class BackofficeSettings {
    ...
    setupEventListeners() {
        ...
        document.getElementById('btc-qr')?.addEventListener('input', (e) => {
            this.settings.paymentMethods.crypto.btc.qrCodeUrl = e.target.value;
        });
        ...
        document.getElementById('eth-address')?.addEventListener('input', (e) => {
            this.settings.paymentMethods.crypto.eth.address = e.target.value;
        });

        document.getElementById('eth-qr')?.addEventListener('input', (e) => {
            this.settings.paymentMethods.crypto.eth.qrCodeUrl = e.target.value;
        });

        document.getElementById('enable-eth-deposits')?.addEventListener('change', (e) => {
            this.settings.paymentMethods.crypto.eth.enabled = e.target.checked;
        });
        ...
        document.getElementById('eth-min-amount')?.addEventListener('input', (e) => {
            this.settings.paymentMethods.crypto.eth.minAmount = parseFloat(e.target.value) || 0;
        });

        document.getElementById('eth-max-amount')?.addEventListener('input', (e) => {
            this.settings.paymentMethods.crypto.eth.maxAmount = parseFloat(e.target.value) || 0;
        });

        document.getElementById('eth-fee-percentage')?.addEventListener('input', (e) => {
            this.settings.paymentMethods.crypto.eth.feePercentage = parseFloat(e.target.value) || 0;
        });

        document.getElementById('eth-fixed-fee')?.addEventListener('input', (e) => {
            this.settings.paymentMethods.crypto.eth.fixedFee = parseFloat(e.target.value) || 0;
        });

        document.getElementById('eth-processing-time')?.addEventListener('input', (e) => {
            this.settings.paymentMethods.crypto.eth.processingTimeHours = parseInt(e.target.value) || 0;
        });

        document.getElementById('eth-instructions')?.addEventListener('input', (e) => {
            this.settings.paymentMethods.crypto.eth.instructions = e.target.value;
        });
    }
    ...
    updateUI() {
        ...
        this.setInputValue('eth-address', this.settings.paymentMethods.crypto.eth.address);
        this.setInputValue('eth-min-amount', this.settings.paymentMethods.crypto.eth.minAmount);
        this.setInputValue('eth-max-amount', this.settings.paymentMethods.crypto.eth.maxAmount);
        this.setInputValue('eth-fee-percentage', this.settings.paymentMethods.crypto.eth.feePercentage);
        this.setInputValue('eth-fixed-fee', this.settings.paymentMethods.crypto.eth.fixedFee);
        this.setInputValue('eth-processing-time', this.settings.paymentMethods.crypto.eth.processingTimeHours);
        this.setInputValue('eth-instructions', this.settings.paymentMethods.crypto.eth.instructions);
        this.setCheckboxValue('enable-eth-deposits', this.settings.paymentMethods.crypto.eth.enabled);
    }
